...
public interface ObjectPool {
	...
	/**
	 * This method will remove the object from available object list and mark it for
	 * garbage collection.
	 *
	 * @param o the o
	 */
	...
	/**
	 * This method will fetch the Object of class type passes to it from available
	 * Object pool.
	 *
	 * @param <T>  the generic type
	 * @param type the type

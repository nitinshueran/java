...
public class Solution
{
    ...
    {
        // Add code here
        if (null == creditCardNumber || creditCardNumber.length() == 0 || "".equals(creditCardNumber) || creditCardNumber.length() < 6)
            return creditCardNumber;
    ...
    private static String mask(String creditCardNumber)
    {
        ...
        StringBuilder builder =
            new StringBuilder(creditCardNumber.substring(0, 1)).append(tmpMasked).append(creditCardNumber.substring(creditCardNumber.length() - 4, creditCardNumber.length()));
